...
const productNames = [
    'Điện thoại iPhone 15 Pro', 'Laptop Dell XPS 15', 'Máy tính bảng Samsung Galaxy Tab',
    'Tai nghe Sony WH-1000XM5', 'Đồng hồ thông minh Apple Watch', 'Camera GoPro Hero 12',
    'Máy ảnh Canon EOS R6', 'Tủ lạnh Panasonic', 'Máy giặt LG', 'Tivi Samsung 55 inch',
    'Quần áo thời trang', 'Giày dép Nike', 'Sách giáo khoa', 'Đồ chơi trẻ em',
    'Mỹ phẩm cao cấp', 'Thực phẩm đông lạnh', 'Thuốc men y tế', 'Văn phòng phẩm',
    'Đồ nội thất', 'Phụ kiện ô tô',
];
...
async function seedOrdersForOrg() {
    ...
    console.log(`🌱 Seeding ${count} orders for organization: ${targetOrgId}...\n`);
    ...
    console.log(`🎉 Done! Refresh your /orders page to see the orders.\n`);
}
