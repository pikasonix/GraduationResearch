-- Add 'user' role to user_role enum for regular users
ALTER TYPE public.user_role ADD VALUE IF NOT EXISTS 'user';

-- Update trigger to set default role as 'user' instead of 'admin'
...
BEGIN
  ...
  BEGIN
    ...
    -- Changed role from 'admin' to 'user' for new signups
