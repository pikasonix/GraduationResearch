...
\restrict PxF74tOEKXB9Guy84hLxUKWuKpuX7hdj9EfrW5gaHt2kMO9fEX8Ar8emT23CcWW
...
ALTER TYPE "public"."optimization_mode" OWNER TO "postgres";
...
ALTER TYPE "public"."optimization_objective" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."generate_tracking_number"() RETURNS character varying
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    prefix VARCHAR(2) := 'VN';
...
BEGIN
    random_num := LPAD(FLOOR(RANDOM() * 10000000000)::TEXT, 10, '0');
...
CREATE OR REPLACE FUNCTION "public"."update_location_geom"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE TABLE IF NOT EXISTS "public"."daily_performance" (
    ...
    "average_delay_minutes" numeric(6,2),
    "avg_capacity_utilization" numeric(5,2),
    "avg_distance_per_order" numeric(8,2),
    "avg_cost_per_order" numeric(12,2),
    "created_at" timestamp with time zone DEFAULT "now"()
);
...
CREATE TABLE IF NOT EXISTS "public"."driver_performance" (
    ...
    "on_time_rate" numeric(5,2),
    "total_distance_km" numeric(10,2) DEFAULT 0,
    "total_working_hours" numeric(6,2) DEFAULT 0,
    "avg_route_deviation_km" numeric(8,2),
    "total_events_reported" integer DEFAULT 0,
    "created_at" timestamp with time zone DEFAULT "now"()
);
...
CREATE TABLE IF NOT EXISTS "public"."driver_schedules" (
    ...
    "max_working_hours" numeric(4,2) DEFAULT 8.0,
...
CREATE TABLE IF NOT EXISTS "public"."optimization_job_logs" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."optimization_job_logs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."optimization_jobs" (
    ...
    "description" "text",
    "optimization_mode" "public"."optimization_mode" DEFAULT 'balanced'::"public"."optimization_mode",
    "optimization_objectives" "public"."optimization_objective"[] DEFAULT ARRAY['minimize_cost'::"public"."optimization_objective"],
    "max_execution_time" integer DEFAULT 600,
    ...
    "current_best_cost" numeric(15,2),
...
CREATE TABLE IF NOT EXISTS "public"."optimization_solutions" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "job_id" "uuid" NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "solution_name" character varying(255),
    "optimization_objective" "public"."optimization_objective" NOT NULL,
    "is_selected" boolean DEFAULT false,
    "total_vehicles_used" integer NOT NULL,
    "total_distance_km" numeric(10,2) NOT NULL,
    "total_time_hours" numeric(10,2) NOT NULL,
    "total_cost" numeric(15,2) NOT NULL,
    "orders_assigned" integer,
    "orders_unassigned" integer,
    "capacity_utilization_avg" numeric(5,2),
    "time_window_violations" integer DEFAULT 0,
    "solution_data" "jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"()
);


ALTER TABLE "public"."optimization_solutions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    ...
    "pickup_contact_phone" character varying(20) NOT NULL,
    ...
    "delivery_contact_name" character varying(255) NOT NULL,
    "delivery_contact_phone" character varying(20) NOT NULL,
    ...
    "service_time_pickup" integer DEFAULT 10,
    "service_time_delivery" integer DEFAULT 10,
...
ALTER TABLE "public"."route_events" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."route_stops" (
    ...
    "planned_waiting_time" integer,
    "actual_arrival_time" timestamp with time zone,
    "actual_departure_time" timestamp with time zone,
    "actual_service_time" integer,
    "actual_waiting_time" integer,
    "load_after_stop" numeric(10,2),
...
CREATE TABLE IF NOT EXISTS "public"."routes" (
    ...
    "planned_duration_hours" numeric(10,2) NOT NULL,
    ...
    "status" "public"."route_status" DEFAULT 'planned'::"public"."route_status",
    "route_data" "jsonb",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
SELECT
    NULL::"uuid" AS "id",
    NULL::character varying(255) AS "route_name",
    NULL::"public"."route_status" AS "status",
    NULL::character varying(20) AS "license_plate",
    NULL::character varying(255) AS "driver_name",
    NULL::numeric(10,2) AS "planned_distance_km",
    NULL::bigint AS "total_stops",
    NULL::bigint AS "completed_stops";


ALTER VIEW "public"."v_active_routes" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."v_order_summary" AS
 SELECT "o"."id",
   ...
   FROM ((("public"."orders" "o"
     LEFT JOIN "public"."route_stops" "rs" ON (("o"."id" = "rs"."order_id")))
     LEFT JOIN "public"."routes" "r" ON (("rs"."route_id" = "r"."id")))
     LEFT JOIN "public"."drivers" "d" ON (("r"."driver_id" = "d"."id")));


ALTER VIEW "public"."v_order_summary" OWNER TO "postgres";
...
ALTER TABLE "public"."vehicle_tracking" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."daily_performance"
    ADD CONSTRAINT "daily_performance_organization_id_date_key" UNIQUE ("organization_id", "date");
...
ALTER TABLE ONLY "public"."distance_matrix"
    ADD CONSTRAINT "distance_matrix_from_location_id_to_location_id_key" UNIQUE ("from_location_id", "to_location_id");
...
ALTER TABLE ONLY "public"."driver_performance"
    ADD CONSTRAINT "driver_performance_driver_id_date_key" UNIQUE ("driver_id", "date");
...
ALTER TABLE ONLY "public"."optimization_job_logs"
    ADD CONSTRAINT "optimization_job_logs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."optimization_solutions"
    ADD CONSTRAINT "optimization_solutions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."route_events"
    ADD CONSTRAINT "route_events_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_api_request_logs_time" ON "public"."api_request_logs" USING "btree" ("requested_at" DESC);



CREATE INDEX "idx_distance_matrix_from" ON "public"."distance_matrix" USING "btree" ("from_location_id");



CREATE INDEX "idx_distance_matrix_to" ON "public"."distance_matrix" USING "btree" ("to_location_id");



CREATE INDEX "idx_driver_schedules_driver_date" ON "public"."driver_schedules" USING "btree" ("driver_id", "work_date");



CREATE INDEX "idx_drivers_active" ON "public"."drivers" USING "btree" ("is_active");
...
CREATE INDEX "idx_job_logs_job" ON "public"."optimization_job_logs" USING "btree" ("job_id", "logged_at" DESC);
...
CREATE INDEX "idx_optimization_jobs_priority" ON "public"."optimization_jobs" USING "btree" ("priority" DESC, "created_at");



CREATE INDEX "idx_optimization_jobs_status" ON "public"."optimization_jobs" USING "btree" ("status");
...
CREATE INDEX "idx_orders_tracking" ON "public"."orders" USING "btree" ("tracking_number");
...
CREATE INDEX "idx_route_events_route" ON "public"."route_events" USING "btree" ("route_id", "reported_at" DESC);



CREATE INDEX "idx_route_stops_route" ON "public"."route_stops" USING "btree" ("route_id", "stop_sequence");
...
CREATE INDEX "idx_routes_solution" ON "public"."routes" USING "btree" ("solution_id");
...
CREATE INDEX "idx_solutions_job" ON "public"."optimization_solutions" USING "btree" ("job_id");
...
CREATE INDEX "idx_vehicle_tracking_geom" ON "public"."vehicle_tracking" USING "gist" ("geom");



CREATE INDEX "idx_vehicle_tracking_vehicle_time" ON "public"."vehicle_tracking" USING "btree" ("vehicle_id", "recorded_at" DESC);
...
CREATE OR REPLACE VIEW "public"."v_active_routes" AS
 SELECT "r"."id",
    ...
    "count"("rs"."id") FILTER (WHERE ("rs"."is_completed" = true)) AS "completed_stops"
   FROM ((("public"."routes" "r"
     LEFT JOIN "public"."vehicles" "v" ON (("r"."vehicle_id" = "v"."id")))
     LEFT JOIN "public"."drivers" "d" ON (("r"."driver_id" = "d"."id")))
     LEFT JOIN "public"."route_stops" "rs" ON (("r"."id" = "rs"."route_id")))
  WHERE ("r"."status" = ANY (ARRAY['assigned'::"public"."route_status", 'in_progress'::"public"."route_status"]))
  GROUP BY "r"."id", "v"."license_plate", "d"."full_name";



CREATE OR REPLACE TRIGGER "auto_tracking_number" BEFORE INSERT ON "public"."orders" FOR EACH ROW EXECUTE FUNCTION "public"."set_tracking_number"();
...
CREATE OR REPLACE TRIGGER "update_locations_geom" BEFORE INSERT OR UPDATE ON "public"."locations" FOR EACH ROW EXECUTE FUNCTION "public"."update_location_geom"();
...
CREATE OR REPLACE TRIGGER "update_optimization_jobs_updated_at" BEFORE UPDATE ON "public"."optimization_jobs" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_vehicle_tracking_geom" BEFORE INSERT ON "public"."vehicle_tracking" FOR EACH ROW EXECUTE FUNCTION "public"."update_location_geom"();
...
ALTER TABLE ONLY "public"."daily_performance"
    ADD CONSTRAINT "daily_performance_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."distance_matrix"
    ADD CONSTRAINT "distance_matrix_from_location_id_fkey" FOREIGN KEY ("from_location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."distance_matrix"
    ADD CONSTRAINT "distance_matrix_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."distance_matrix"
    ADD CONSTRAINT "distance_matrix_to_location_id_fkey" FOREIGN KEY ("to_location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."notifications"
    ADD CONSTRAINT "notifications_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."optimization_jobs"("id");
...
ALTER TABLE ONLY "public"."optimization_job_logs"
    ADD CONSTRAINT "optimization_job_logs_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."optimization_jobs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."optimization_jobs"
    ADD CONSTRAINT "optimization_jobs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."optimization_jobs"
    ADD CONSTRAINT "optimization_jobs_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."optimization_solutions"
    ADD CONSTRAINT "optimization_solutions_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."optimization_jobs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."optimization_solutions"
    ADD CONSTRAINT "optimization_solutions_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."route_events"
    ADD CONSTRAINT "route_events_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id");



ALTER TABLE ONLY "public"."route_events"
    ADD CONSTRAINT "route_events_reported_by_fkey" FOREIGN KEY ("reported_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."route_events"
    ADD CONSTRAINT "route_events_route_id_fkey" FOREIGN KEY ("route_id") REFERENCES "public"."routes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."route_events"
    ADD CONSTRAINT "route_events_route_stop_id_fkey" FOREIGN KEY ("route_stop_id") REFERENCES "public"."route_stops"("id");



ALTER TABLE ONLY "public"."route_stops"
    ADD CONSTRAINT "route_stops_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id");



ALTER TABLE ONLY "public"."route_stops"
    ADD CONSTRAINT "route_stops_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."routes"
    ADD CONSTRAINT "routes_assigned_by_fkey" FOREIGN KEY ("assigned_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."routes"
    ADD CONSTRAINT "routes_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id");
...
ALTER TABLE ONLY "public"."routes"
    ADD CONSTRAINT "routes_solution_id_fkey" FOREIGN KEY ("solution_id") REFERENCES "public"."optimization_solutions"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."vehicle_tracking"
    ADD CONSTRAINT "vehicle_tracking_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id");



ALTER TABLE ONLY "public"."vehicle_tracking"
    ADD CONSTRAINT "vehicle_tracking_route_id_fkey" FOREIGN KEY ("route_id") REFERENCES "public"."routes"("id");
...
GRANT ALL ON FUNCTION "public"."set_tracking_number"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_tracking_number"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."update_location_geom"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_location_geom"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_location_geom"() TO "service_role";
...
GRANT ALL ON TABLE "public"."daily_performance" TO "anon";
GRANT ALL ON TABLE "public"."daily_performance" TO "authenticated";
GRANT ALL ON TABLE "public"."daily_performance" TO "service_role";



GRANT ALL ON TABLE "public"."distance_matrix" TO "anon";
GRANT ALL ON TABLE "public"."distance_matrix" TO "authenticated";
GRANT ALL ON TABLE "public"."distance_matrix" TO "service_role";
...
GRANT ALL ON TABLE "public"."optimization_job_logs" TO "anon";
GRANT ALL ON TABLE "public"."optimization_job_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."optimization_job_logs" TO "service_role";



GRANT ALL ON TABLE "public"."optimization_jobs" TO "anon";
GRANT ALL ON TABLE "public"."optimization_jobs" TO "authenticated";
GRANT ALL ON TABLE "public"."optimization_jobs" TO "service_role";



GRANT ALL ON TABLE "public"."optimization_solutions" TO "anon";
GRANT ALL ON TABLE "public"."optimization_solutions" TO "authenticated";
GRANT ALL ON TABLE "public"."optimization_solutions" TO "service_role";
...
GRANT ALL ON TABLE "public"."route_events" TO "anon";
GRANT ALL ON TABLE "public"."route_events" TO "authenticated";
GRANT ALL ON TABLE "public"."route_events" TO "service_role";
...
GRANT ALL ON TABLE "public"."v_active_routes" TO "anon";
GRANT ALL ON TABLE "public"."v_active_routes" TO "authenticated";
GRANT ALL ON TABLE "public"."v_active_routes" TO "service_role";



GRANT ALL ON TABLE "public"."v_order_summary" TO "anon";
GRANT ALL ON TABLE "public"."v_order_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."v_order_summary" TO "service_role";



GRANT ALL ON TABLE "public"."vehicle_tracking" TO "anon";
GRANT ALL ON TABLE "public"."vehicle_tracking" TO "authenticated";
GRANT ALL ON TABLE "public"."vehicle_tracking" TO "service_role";
...
\unrestrict PxF74tOEKXB9Guy84hLxUKWuKpuX7hdj9EfrW5gaHt2kMO9fEX8Ar8emT23CcWW
