...
COMMENT ON FUNCTION "public"."handle_new_user"() IS 'Automatically creates organization and user record when a new auth user is created. Enhanced with error logging.';
...
CREATE POLICY "Service role can do anything on organizations" ON "public"."organizations" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Service role can do anything on users" ON "public"."users" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "Users can view their organization" ON "public"."organizations" FOR SELECT TO "authenticated" USING (("id" IN ( SELECT "users"."organization_id"
   FROM "public"."users"
