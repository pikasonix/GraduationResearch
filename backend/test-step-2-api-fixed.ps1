#!/usr/bin/env pwsh
# BUOC 2: TEST BACKEND SERVER & API ENDPOINT
# ==================================================
...
# Test 2.2: Test /reoptimize endpoint
...
Write-Host "`nBUOC 2 HOAN THANH!" -ForegroundColor Green
...
Write-Host "  Tiep tuc sang Buoc 3...`n" -ForegroundColor Gray
